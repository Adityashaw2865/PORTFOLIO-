...
const skillGroups = [
  { category: 'Languages', items: [{ name: 'C++', level: 85 }, { name: 'C', level: 75 }, { name: 'JavaScript', level: 78 }, { name: 'Python', level: 40 }] },
  { category: 'Frontend', items: [{ name: 'React.js', level: 80 }, { name: 'HTML5', level: 88 }, { name: 'CSS3', level: 82 }, { name: 'Tailwind CSS', level: 80 }] },
  { category: 'Backend', items: [{ name: 'Node.js', level: 68 }, { name: 'Express.js', level: 65 }] },
  { category: 'Tools', items: [{ name: 'Git', level: 78 }, { name: 'GitHub', level: 80 }, { name: 'VS Code', level: 90 }] },
]
    ...
    <section id="skills" className="py-28 px-6 relative">
      ...
      <div className="max-w-5xl mx-auto" ref={ref}>
        <motion.div variants={stagger} initial="hidden" animate={inView ? 'visible' : 'hidden'}>
          ...
          <motion.div variants={stagger} className="grid sm:grid-cols-2 xl:grid-cols-4 gap-5">
